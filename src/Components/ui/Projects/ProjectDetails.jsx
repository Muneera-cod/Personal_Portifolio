...
function ProjectDetails() {
  return (
  <section className='flex flex-col pt-[120px] sm:px-[25px] md:px-[30px] lg:px-[40px] gap-10 py-10 slide-in-bottom'>
    ...
    <div className=' grid sm:grid-cols-1 md:grid-cols-2  lg:grid-cols-3  gap-10 text-md'>
      { projects.map((project,index)=><div  key={index} className='h-[500px] max-h-[500px] min-h-[500px] flex flex-col gap-4 boxShadow sm:px-6 md:px-8 lg:px-10 py-8 hover:scale-[1.030] shadow-lg bg-hoverNavClr rounded-md border-[0.5px] border-hoverNavClr border-opacity-20 bg-opacity-10'>
